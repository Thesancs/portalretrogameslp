...
const SoundToggle = ({ orientation = 'vertical' }: SoundToggleProps) => {
  ...
  const content = (
    <button
      ...
      className="btn-pixel-accent glow-ring flex items-center gap-3 rounded-full !px-6 !py-3 text-xs font-semibold uppercase tracking-[0.25em] sm:gap-4 sm:tracking-[0.35em]"
    >
      ...
      <div className="retro-panel w-full max-w-xl rounded-3xl px-5 py-4 sm:px-6">
        <div className="retro-panel-content flex flex-col items-center gap-4 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1 text-left text-[10px] uppercase tracking-[0.22em] text-muted-foreground sm:text-xs sm:tracking-[0.35em]">
              <p>Passo 01</p>
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      <div className="retro-panel-content flex flex-col items-center gap-3">
        ...
        <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground sm:tracking-[0.35em]">
